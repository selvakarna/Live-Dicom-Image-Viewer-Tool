...
def dir_selector(folder_path='/home/selva/Selva/Personal/Webimg/DICOM'):
...
st.sidebar.title('SK-DICOM-Viewer-Tool')
# dirname = dir_selector()
dirname='/home/selva/Selva/Personal/Webimg/DICOM'
